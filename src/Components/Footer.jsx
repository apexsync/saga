...
function Footer() {
    return (
        <footer className="w-full bg-black text-white py-16 font-Poppins">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
                ...
                <div className="flex flex-col items-center md:items-center space-y-4">
                    ...
                    <nav className="grid grid-cols-2 gap-2 text-gray-400">
                        ...
                        <Link to="/pendant" className="hover:text-white transition-colors duration-300">Pendant</Link>
                        <Link to="/necklace" className="hover:text-white transition-colors duration-300">Necklace</Link>
