...
//                 {/* Image 1: Tall */}
//                 {content.items[0] && <img src={content.items[0].src} alt={content.items[0].alt} className="rounded-2xl md:h-[30vw] h-[40vw] w-full object-cover hover:scale-105 transform transition-transform duration-300" />}
                
//                 {/* Image 2: Short */}
//                 {content.items[1] && <img src={content.items[1].src} alt={content.items[1].alt} className="rounded-2xl md:h-[30vw] h-[30vw] w-full object-cover hover:scale-105 transform transition-transform duration-300" />}
                
//                 {/* Image 3: Short */}
//                 {content.items[2] && <img src={content.items[2].src} alt={content.items[2].alt} className="rounded-2xl md:h-[30vw] h-[30vw] w-full object-cover hover:scale-105 transform transition-transform duration-300" />}
                
//                 {/* Image 4: Tall */}
//                 {content.items[3] && <img src={content.items[3].src} alt={content.items[3].alt} className="rounded-2xl md:h-[30vw] h-[40vw] w-full object-cover hover:scale-105 transform transition-transform duration-300" />}
//             </div>
//          </div>
